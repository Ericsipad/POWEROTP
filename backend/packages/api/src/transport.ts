 ...
 * (`GET /v1/nodes/jobs/next`, see `backend/packages/api/src/node-service.ts` and the
 * route under `backend/apps/server/app/v1/nodes/jobs`). This process never talks to

...
import { csrfCookieOptions, sessionCookieOptions } from "./cookie-options";
 ...
 * `backend/packages/api/src/auth-service.ts#decryptEmail`. */
...
export function setSessionCookies(
  ...
  response.cookies.set(CSRF_COOKIE, csrfToken, csrfCookieOptions(expiresAt));
}

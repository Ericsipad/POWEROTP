...
| --- | --- | --- | --- | --- | --- | --- |
| `app/health/hosted-auth/route.ts` | `/health/hosted-auth` | `GET` | Exact hosted-auth realm host | public | App Platform and hosted-auth uptime probes | `https://authx.powerotp.com`, `https://authz.powerotp.com` |

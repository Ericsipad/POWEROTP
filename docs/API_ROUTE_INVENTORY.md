...
| `app/v1/projects/[projectId]/audit-history/route.ts` | `/v1/projects/{projectId}/audit-history` | `GET` | Customer session + project ownership | browser | Project-card configuration and security history | `https://api.powerotp.com` |
| `app/v1/projects/[projectId]/auth-return-urls/route.ts` | `/v1/projects/{projectId}/auth-return-urls` | `GET, PUT` | Customer session + project ownership; CSRF on PUT | browser | Project-card hosted-auth return URL controls | `https://api.powerotp.com` |
...
| `app/v1/projects/[projectId]/auth-settings/route.ts` | `/v1/projects/{projectId}/auth-settings` | `GET, PATCH` | Customer session + project ownership; CSRF on PATCH | browser | Project-card hosted-auth service and policy controls | `https://api.powerotp.com` |
...
| `app/v1/projects/[projectId]/botblocker/route.ts` | `/v1/projects/{projectId}/botblocker` | `GET, PATCH` | Customer session + project ownership; CSRF on PATCH | browser | Dashboard-only private BotBlocker timeout, enablement, and OTP risk-marker settings | `https://api.powerotp.com` |

...
| `app/v1/botblocker/agent/entitlements/[webhookId]/route.ts` | `/v1/botblocker/agent/entitlements/{webhookId}` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | BotBlocker agents/adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/browser-assessment/[webhookId]/route.ts` | `/v1/botblocker/browser-assessment/{webhookId}` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | Browser BotBlocker adapters through their server bridge | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/challenges/[webhookId]/[challengeId]/complete/route.ts` | `/v1/botblocker/challenges/{webhookId}/{challengeId}/complete` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | BotBlocker challenge clients | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/challenges/[webhookId]/[challengeId]/route.ts` | `/v1/botblocker/challenges/{webhookId}/{challengeId}` | `GET` | Project-scoped `webhookId` path + BotBlocker site credential + signed read headers | server-to-server | BotBlocker challenge clients | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/challenges/[webhookId]/route.ts` | `/v1/botblocker/challenges/{webhookId}` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | BotBlocker challenge clients | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/paid-passes/assert/[webhookId]/route.ts` | `/v1/botblocker/paid-passes/assert/{webhookId}` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | BotBlocker paid-pass adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/passports/assert/[webhookId]/route.ts` | `/v1/botblocker/passports/assert/{webhookId}` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | BotBlocker passport adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/passports/register/[webhookId]/route.ts` | `/v1/botblocker/passports/register/{webhookId}` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | BotBlocker passport adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
...
| `app/v1/botblocker/rapid-auth/[webhookId]/route.ts` | `/v1/botblocker/rapid-auth/{webhookId}` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | BotBlocker rapid-check adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/risk-events/[webhookId]/route.ts` | `/v1/botblocker/risk-events/{webhookId}` | `POST` | Project-scoped `webhookId` path + BotBlocker site credential + signed envelope | server-to-server | BotBlocker adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
...
| `app/v1/control/botblocker/rapid-list/route.ts` | `/v1/control/botblocker/rapid-list` | `GET, POST` | Admin session; CSRF on POST | admin | BotBlocker operators; no frontend consumer yet | `https://api.powerotp.com` |

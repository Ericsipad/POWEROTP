...
| `app/v1/botblocker/agent/entitlements/route.ts` | `/v1/botblocker/agent/entitlements` | `POST` | BotBlocker site credential + signed envelope | server-to-server | BotBlocker agents/adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/browser-assessment/route.ts` | `/v1/botblocker/browser-assessment` | `POST` | BotBlocker site credential + signed envelope | server-to-server | Browser BotBlocker adapters through their server bridge | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/challenges/[challengeId]/complete/route.ts` | `/v1/botblocker/challenges/{challengeId}/complete` | `POST` | BotBlocker site credential + signed envelope | server-to-server | BotBlocker challenge clients | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/challenges/[challengeId]/route.ts` | `/v1/botblocker/challenges/{challengeId}` | `GET` | BotBlocker site credential + signed read headers | server-to-server | BotBlocker challenge clients | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/challenges/route.ts` | `/v1/botblocker/challenges` | `POST` | BotBlocker site credential + signed envelope | server-to-server | BotBlocker challenge clients | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/paid-passes/assert/route.ts` | `/v1/botblocker/paid-passes/assert` | `POST` | BotBlocker site credential + signed envelope | server-to-server | BotBlocker paid-pass adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/passports/assert/route.ts` | `/v1/botblocker/passports/assert` | `POST` | BotBlocker site credential + signed envelope | server-to-server | BotBlocker passport adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/passports/register/route.ts` | `/v1/botblocker/passports/register` | `POST` | BotBlocker site credential + signed envelope | server-to-server | BotBlocker passport adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
...
| `app/v1/botblocker/rapid-auth/route.ts` | `/v1/botblocker/rapid-auth` | `POST` | BotBlocker site credential + signed envelope | server-to-server | BotBlocker rapid-check adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |
| `app/v1/botblocker/risk-events/route.ts` | `/v1/botblocker/risk-events` | `POST` | BotBlocker site credential + signed envelope | server-to-server | BotBlocker adapters | Planned `https://verify.powerotp.com`; master/fallback `https://api.powerotp.com` |

...
| `app/v1/projects/[projectId]/auth-return-urls/route.ts` | `/v1/projects/{projectId}/auth-return-urls` | `GET, PUT` | Customer session + project ownership; CSRF on PUT | browser | Hosted-auth project configuration API; Project-card consumer deferred to P3-S4 | `https://api.powerotp.com` |
...
| `app/v1/projects/[projectId]/auth-settings/route.ts` | `/v1/projects/{projectId}/auth-settings` | `GET, PATCH` | Customer session + project ownership; CSRF on PATCH | browser | Hosted-auth project configuration API; Project-card consumer deferred to P3-S4 | `https://api.powerotp.com` |

...
| A.8.29 | Security testing in development and acceptance | Partially implemented | Phase 1–8 suites exercise strict contracts, credential hashing/rotation, tenant/site/host/audience binding, bounded timestamps, idempotency/replay/storage failure, unavailable responses, policy signing/publication, retention, and rollback controls; deployed end-to-end acceptance and penetration testing remain Phase 31 |

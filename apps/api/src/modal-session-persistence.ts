 ...
 * up front — see `apps/api/src/modal-session-service.ts` and
 ...
 * `apps/web/app/widget/[sessionId]/page.tsx` and the logging route under
 * `apps/web/app/v1/modal-sessions/[sessionId]/ai-index-summary/route.ts`).
